...
// Aquí es donde sucede la magia: saltamos la pregunta y elegimos QR (1)
if (
  !methodCodeQR &&
  !methodCode &&
  ...
  console.log(
    chalk.magenta.bold(
      "\n\n💖 Saltando menú: Generando código QR directamente...",
    ),
  );
  opcion = "1";
}
...
const connectionOptions = {
  ...
  msgRetryCounterCache: msgRetryCounterCache,
    ...
    version: version, // <--- CAMBIA LA LISTA DE NÚMEROS POR ESTA PALABRA
