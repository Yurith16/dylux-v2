...
case 'culos':
    ...
    conn.sendFile(m.chat, as.data, 'img.jpg', `✅ ${mssg.random} *${command}*`, m, null, fwc)
...
case 'boobies':
    ...
    conn.sendFile(m.chat, xb.data, 'img.jpg', `✅ ${mssg.random} *${command}*`, m, null, fwc)
   m.react(xmoji) 
break

case 'pussy':
    let xp = await conn.getFile(global.API('fgmods', '/api/nsfw/pussy', { }, 'apikey'))
    conn.sendFile(m.chat, xp.data, 'img.jpg', `✅ ${mssg.random} *${command}*`, m, null, fwc)
    m.react(xmoji) 
break
...
case 'lesbian':
    ...
    conn.sendFile(m.chat, les.data, 'img.jpg', `✅ ${mssg.random} *${command}*`, m, null, fwc)
    m.react(xmoji) 
break
...
case 'cosplay':
        ...
        conn.sendFile(m.chat, img.data, 'img.jpg', `✅ ${mssg.result} 🤭`, m, null, fwc)
	     m.react(xmoji) 
	break
